            ...
            <form action="/admin/goods" method="get">
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter">
                    <label>商品名:<input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" name="gname" value="<?php echo e($request->name); ?>">
                    </label>
                    ...
                    role="grid" aria-describedby="example1_info" >
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img src="<?php echo e($v->src); ?>" width="100px"></td>
                                <td><?php echo e($v->content); ?></td>
                                <td><?php echo e(date('Y-m-d H:i:s',$v->addtime)); ?></td>
                                <td>
                                    <a href="/admin/poster/<?php echo e($v->id); ?>/edit" class='btn btn-info'>修改</a>

                                    <form action="/admin/poster/<?php echo e($v->id); ?>" method='post' style='display:inline'>
