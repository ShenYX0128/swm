        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo e($user->header); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo e($user->username); ?></span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="background: url('/admins/dist/img/photo1.png') center center;">
                ...
                <img src="<?php echo e($user->header); ?>" class="img-circle" alt="User Image">
