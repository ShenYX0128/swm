				...
				<div class="main-wrap">
					...
					<form id="art_form" action="/home/update" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
						...
						<?php endif; ?>
							...
							<div class="info-m">
								<div><b>用户名：<i><?php echo e($customer->customername); ?></i></b></div>
								<div class="u-level">
									<span class="rank r2">
						...
						<div class="info-main">
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" placeholder="nickname" name="customername" value="<?php echo e($customer->customername); ?>">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content sex">
										<label class="am-radio-inline">
											<input type="radio" name="sex" value="1" data-am-ucheck <?php if($customer->sex== 1): ?> checked <?php endif; ?>> 男
										</label>
										<label class="am-radio-inline">
											<input type="radio" name="sex" value="0" data-am-ucheck <?php if($customer->sex== 0): ?> checked <?php endif; ?>> 女
										</label>
										<label class="am-radio-inline">
											<input type="radio" name="sex" value="2" data-am-ucheck <?php if($customer->sex== 2): ?> checked <?php endif; ?>> 保密
										</label>
									</div>
								</div>
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" placeholder="telephonenumber" type="tel" name="phone" value="<?php echo e($customer->phone); ?>">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-email" placeholder="Email" type="email" name="email" value="<?php echo e($customer->email); ?>">
