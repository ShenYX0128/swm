            ...
            <form action="/admin/banner" method="get">
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter">
                    <label>链接名称:<input type="text" class="form-control input-sm" placeholder="" aria-controls="example1" name="url" value="<?php echo e($request->url); ?>">
                    </label>
                    ...
                    role="grid" aria-describedby="example1_info" size="1" style="" >
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><?php echo e($v->src); ?></td>

                                <td>
                                    <a href="/admin/banner/<?php echo e($v->id); ?>/edit" class='btn btn-info'>修改</a>

                                  <form action="/admin/banner/<?php echo e($v->id); ?>" method='post' style='display:inline'>
