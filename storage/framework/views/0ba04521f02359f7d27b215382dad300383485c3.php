...
<?php $__env->startSection('content'); ?>
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li class="banner<?php echo e($k+1); ?>"><a href="introduction.html"><img src="<?php echo e($v->src); ?>" style="width:1010px;height:455px;"></a></li>
											...
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i>
														...
														<a class="ml-22" title="点心" href="/home/list/<?php echo e($v->id); ?>"><?php echo e($v->tname); ?></a>
													</h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															...
															<?php $__currentLoopData = $v->sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk=>$vv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<div class="sort-side" >
																	<dl class="dl-sort">
																		<dt style=""><span title=""><a href="/home/inx/<?php echo e($vv->id); ?>" style="color: #db3e54;"><?php echo e($vv->tname); ?></a></span></dt>
																			<?php $__currentLoopData = $vv->sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a=>$b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																			<dd><a title="" href="/home/list/<?php echo e($b->id); ?>"><span><?php echo e($b->tname); ?></span></a></dd>
																			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																	</dl>
																</div>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					...
					<div class="marqueen">
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								...
								<?php else: ?>
									<a href="#">
										<img src="<?php echo e($customer->profile); ?>">
									</a>
								<?php endif; ?>
								<em>
								<?php if(!$customer->customername): ?>
									Hi,<span class="s-name"><?php echo e($customer->phone); ?></span>
								<?php else: ?>	
									Hi,<span class="s-name"><?php echo e($customer->customername); ?></span>
								<?php endif; ?>	
			...
			<div class="shopMainbg">
				<div class="shopMain" id="shopmain">
					...
					<div class="am-container activity ">
						...
						<div id="friends">
						    <div class="mr_frbox">
    							...
    							<ul id="mr_fu">
						    	<?php $__currentLoopData = $adv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<li class="am-u-sm-3 adv_child" style="overflow:hidden;position:relative; left: 15px; margin-left: 3px;" >
										<!-- <div class="icon-sale one "></div>	
											<h4>秒杀</h4>	 -->						
										<div class="activityMain ">
											<img src="<?php echo e($v->src); ?>" width="100%"></img>
										</div>
										<div class="info ">
											<h3><?php echo e($v->content); ?></h3>
										</div>
									</li>							
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</ul>	
					...
					<?php $__currentLoopData = $array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if($v->id == $n): ?>
                    <div id="f<?php echo e($v->id); ?>">
					<!--甜点-->
					
					<div class="am-container ">
						<div class="shopTitle ">
							<h4><?php echo e($v->tname); ?></h4>
							<div class="today-brands ">
								<?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke =>$va): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($v->id == $va->pid): ?>
										<a href="# "><?php echo e($va->tname); ?></a>
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</div>
							<span class="more ">
					...
					<div class="am-g am-g-fixed floodFour">
						...
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
								<?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke =>$va): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($v->id == $va->pid): ?>
									<a class="outer" href="#"><span class="inner"><b class="text"><?php echo e($va->tname); ?></b></span></a>	
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>					
							</div>
						...
						<?php $__currentLoopData = $gods[$n]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php if($v->id == $val->pid): ?>
						<?php if($key == 0): ?>
						<div class="am-u-sm-7 am-u-md-4 text-two sug">
						<?php $__currentLoopData = $img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vlu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php if($vlu->gid == $val->id): ?>
								<a href="http://g-mall.cn/home/detail/<?php echo e($val->id); ?>"><img src="<?php echo e($vlu->gpic); ?>" width="180" height="180" /></a>
								<?php endif; ?>						
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<div class="outer-con ">
									<div class="title " title="<?php echo e($val->gname); ?>">
										<?php echo e($val->gname); ?>
									...
									<a href="http://g-mall.cn/home/detail/<?php echo e($val->id); ?>"><i class="am-icon-shopping-basket am-icon-md  seprate"></i></a>
								</div>
							</div>
						<?php elseif($key == 1): ?>
