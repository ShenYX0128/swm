            ...
            <form action="/admin/category" method="get">
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter">
                    <label>商品名:<input type="text" class="form-control input-sm" placeholder="" aria-controls="example1" name="tname" value="<?php echo e($request->tname); ?>">
                    </label>
                    ...
                    role="grid" aria-describedby="example1_info" size="1" style="" >
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td width='220px'>
                                    <a href="/admin/category/<?php echo e($v->id); ?>/edit" class='btn btn-info'>修改</a>
                                    <!-- <a href="/admin/category/<?php echo e($v->id); ?>" class='btn btn-info'>添加子分类</a> -->

                                    <form action="/admin/category/<?php echo e($v->id); ?>" method='post' style='display:inline'>
