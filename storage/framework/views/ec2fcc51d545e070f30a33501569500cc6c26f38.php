            ...
            <form action="/admin/comment" method="get">
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter">
                    <label>商品名:<input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" name="gname" value="<?php echo e($request->content); ?>">
                    </label>
                    ...
                    role="grid" aria-describedby="example1_info">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($v->uid == $val->id): ?>
                                ...
                                <td>
                                    <form action="/admin/comment/<?php echo e($v->id); ?>" method='post' style='display:inline'>
