					...
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								...
								<li>
									<img src="<?php echo e($v->gpic); ?>" title="pic" />
								</li>
					...
					<div class="clearfixLeft" id="clearcontent">
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="<?php echo e($img->gpic); ?>"><img src="<?php echo e($img->gpic); ?>" alt="细节展示放大镜特效" rel="<?php echo e($img->gpic); ?>" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								...
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="<?php echo e($v->gpic); ?>" mid="<?php echo e($v->gpic); ?>" big="<?php echo e($v->gpic); ?>"></a>
									</div>
								</li>
								<?php else: ?>
								<li>
						...
						<div class="tb-detail-list">
							...
							<ul class="tm-ind-panel">
								...
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count"><?php echo e($v->num); ?></span></div>
								</li>
									...
									<div class="norns" >
										...
										<div class="theme-popbod" >
											<form class="theme-signin" id="close" action="" method="post">
												...
												<input type="hidden" gid="<?php echo e($v->id); ?>" id="hidden" value="<?php if($v->discount): ?>
														 ...
														 <?php endif; ?>">
												<input type="hidden" name="gid" value="<?php echo e($v->id); ?>">
												<div class="theme-signin-left" style="width: 100%;">

													<div class="theme-options">
														<div class="cart-title">口味</div>
														<ul class="taste">
															<?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<li class="sku-line <?php if($ke == 0): ?>selected <?php endif; ?>"><?php echo e($val); ?><i></i></li>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										...
										<div class="theme-popbod" >
											<form class="theme-signin" name="loginform" action="" method="" id="forms">
												...
												<div class="theme-signin-right">
													<div class="img-info">
														<img src="<?php echo e($img->gpic); ?>" />
													</div>
													<div class="text-info">
														<span class="J_Price price-now">¥<?php if($v->discount): ?>
															<?php echo e($v->discount); ?>
