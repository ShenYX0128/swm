            ...
            <form action="/admin/role" method="get">
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter">
                    <label>角色名:<input type="search" class="form-control input-sm" placeholder="" aria-controls="example1" name="role_name" value="<?php echo e($request->role_name); ?>">
                    </label>
                    ...
                    role="grid" aria-describedby="example1_info" size="1" style="text-align: center;" >
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                <a href="/admin/role/<?php echo e($v->id); ?>/edit" class='btn btn-info'>修改</a>

                                <form action="/admin/role/<?php echo e($v->id); ?>" method='post' style='display:inline'>
                                ...
                                <a href="/admin/role_per?id=<?php echo e($v->id); ?>" class='btn btn-success'>添加权限</a>
                                </form>
                                </td>
                            </tr>
