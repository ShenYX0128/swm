            ...
            <form action="/admin/orders_status" method="get">
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter">
                    <label>状态:<input type="text" class="form-control input-sm" placeholder="" aria-controls="example1" name="fname" value="<?php echo e($request->name); ?>">
                    </label>
                    ...
                    role="grid" aria-describedby="example1_info" size="1" style="" >
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <a href="/admin/orders_status/<?php echo e($v->id); ?>/edit" class='btn btn-info'>修改</a>
