    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/admin/friend/<?php echo e($res->id); ?>" method="post" ">
                <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        placeholder="请输入商品的名称" value="<?php echo e($res->fname); ?>">
                    </div>      
                     ...
                     <div class="form-group">
                        ...
                        placeholder="请输入商品的名称" value="<?php echo e($res->url); ?>">
                    </div>
