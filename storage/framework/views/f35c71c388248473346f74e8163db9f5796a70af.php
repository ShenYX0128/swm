							...
							<?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k =>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										...
										<span class="street" style="word-wrap:break-word;"><?php echo e($v->location); ?></span></p>
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									...
									<form action="/home/addupdate/<?php echo e($add->id); ?>" method="post" class="am-form am-form-horizontal" id="forms">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												...
												<input id="user-phone" placeholder="" type="tel" name="phone" value="<?php echo e($add->phone); ?>">
												<span> *请输入手机号</span>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												...
												<textarea class="" rows="3" id="user-intro" placeholder="" name="location" ><?php echo e($add->location); ?></textarea>

												<span>*50字以内写出你的详细地址...</span>

											</div>
										</div>
										<input type="hidden" value="<?php echo e($add->cid); ?>" name="cid">
										<div class="am-form-group">
