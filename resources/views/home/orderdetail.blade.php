				...
				<div class="main-wrap">
					...
					<div class="user-order">
						...
						<div class="order-infoaside">
							@foreach($addrs as $k => $ad)
							@if($ad->id == $v->o_address)
							<div class="order-addresslist">
								<div class="order-address">
									<div class="icon-add">
									</div>
									<p class="new-tit new-p-re">
										<span class="new-txt">{{$ad->name}}</span>
										<span class="new-txt-rd2">{{$ad->phone}}</span>
									</p>
									<div class="new-mu_l2a new-p-re">
										<p class="new-mu_l2cw">
											<span class="title">收货地址：{{$ad->location}}</span>
													...
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="@php
								                                           ...
								                                           echo $tu->gpic;
								                                        @endphp" class="itempic J_ItemImg">
														</a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#">
																<p>{{$vv->gname}} </p>
																<p class="info-little">{{$vv->norns}}</p>
															</a>
														</div>
													</div>
												</li>
