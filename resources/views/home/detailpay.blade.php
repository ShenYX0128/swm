						...
						<ul>
							...
							<li class="user-addresslist @if($v->status == 0) defaultAddr @endif">
								...
								<div class="new-addr-btn">
									...
									<a href="/home/personal/addedit/{{$v->id}}">编辑</a>
								...
								<div class="bundle  bundle-last">
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="{{$v->gpic}}" width="80" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">{{$val->gname}}</a>
														</div>
													</div>
												</li>
												<li class="td td-info">
													<div class="item-props">
														<span class="sku-line">口味：{{$val->norns}}</span>
													</div>
												</li>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															<input class="text_box" name="" type="text" value="{{$val->d_num}}" style="width:30px;" />
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number">{{$val->d_num*$val->price}}</em>
												</div>
											</li>
										</ul>
										<div class="clear"></div>
						...
						<!--留言-->
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
									...
									<input type="hidden" name="" id="ord_id" value="{{$order->id}}">
